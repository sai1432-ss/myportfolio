    ...
    <section id="hero" className="min-h-screen pt-20 flex items-center px-6 lg:px-12 max-w-7xl mx-auto overflow-hidden relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full z-10">
        ...
        >
          ...
          >
            Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">SAI SATISH RAJAPANTHULA</span>
          </motion.h1>
          <motion.h2
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <a href="resume.pdf" className="flex items-center gap-2 border border-slate-600 hover:bg-slate-800 text-white px-6 py-3 rounded-lg font-medium transition-colors">
